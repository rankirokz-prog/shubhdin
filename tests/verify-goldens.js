...
// NOTE: the sadeSati run-date sanitizer that used to live here has been
// REMOVED. It masked clock drift by stripping the outermost period edges —
// which also meant those edges were never verified at all. The generator and
// this file now both pin SS_REF, so the snapshot depends on engine behaviour
// only and EVERY field, including the window edges, is compared in full.
function sanitize(o){ return o; }
