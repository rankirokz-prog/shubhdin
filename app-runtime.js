...
(function(w){
  ...
  var copy={
    checkoutLock:['Review the details carefully. They are locked when you start payment.','विवरण ध्यान से जाँच लें। भुगतान शुरू करने पर इन्हें बदला नहीं जा सकेगा।','వివరాలను జాగ్రత్తగా చూసుకోండి. చెల్లింపు ప్రారంభించిన తర్వాత వాటిని మార్చలేరు.','ವಿವರಗಳನ್ನು ಎಚ್ಚರಿಕೆಯಿಂದ ಪರಿಶೀಲಿಸಿ. ಪಾವತಿ ಆರಂಭಿಸಿದ ನಂತರ ಅವನ್ನು ಬದಲಾಯಿಸಲಾಗುವುದಿಲ್ಲ.','விவரங்களை கவனமாகச் சரிபார்க்கவும். பணம் செலுத்தத் தொடங்கிய பிறகு அவற்றை மாற்ற முடியாது.','তথ্য ভালো করে মিলিয়ে নিন। পেমেন্ট শুরু করলে আর বদলানো যাবে না।','तपशील नीट तपासा. पेमेंट सुरू केल्यानंतर ते बदलता येणार नाहीत.','વિગતો કાળજીથી તપાસો. ચુકવણી શરૂ કર્યા પછી તે બદલી શકાશે નહીં.','তথ্য ভালদৰে মিলাই লওক। পেমেণ্ট আৰম্ভ কৰাৰ পিছত সলনি কৰিব নোৱাৰিব।'],
    checkoutLocked:['This checkout already has saved details. Use those details or contact support to correct them.','इस चेकआउट के विवरण पहले से सेव हैं। उन्हीं विवरणों का उपयोग करें या सुधार के लिए सहायता लें।','ఈ చెల్లింపు కోసం వివరాలు ఇప్పటికే సేవ్ అయ్యాయి. అవే వివరాలు వాడండి లేదా సవరణ కోసం సహాయ బృందాన్ని సంప్రదించండి.','ಈ ಪಾವತಿಯ ವಿವರಗಳು ಈಗಾಗಲೇ ಉಳಿದಿವೆ. ಅದೇ ವಿವರಗಳನ್ನು ಬಳಸಿ ಅಥವಾ ತಿದ್ದುಪಡಿಗೆ ಸಹಾಯ ಪಡೆಯಿರಿ.','இந்தக் கட்டணத்திற்கான விவரங்கள் ஏற்கெனவே சேமிக்கப்பட்டுள்ளன. அவற்றைப் பயன்படுத்தவும் அல்லது திருத்த உதவியை நாடவும்.','এই পেমেন্টের তথ্য আগে থেকেই সেভ আছে। সেই তথ্য ব্যবহার করুন বা সংশোধনের জন্য সহায়তা নিন।','या पेमेंटचे तपशील आधीच सेव्ह आहेत. तेच तपशील वापरा किंवा दुरुस्तीसाठी मदत घ्या.','આ ચુકવણીની વિગતો પહેલેથી સાચવેલી છે. એ જ વિગતો વાપરો અથવા સુધારા માટે મદદ લો.','এই পেমেণ্টৰ তথ্য আগতেই সংৰক্ষিত আছে। সেই তথ্য ব্যৱহাৰ কৰক বা শুধৰণিৰ বাবে সহায় লওক।'],
